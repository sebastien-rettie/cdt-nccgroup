...
if not previously_tuned:
    ...
    print("Plotting validation curve for min_samples_split...")
    ...
    print("Plotting validation curve for max_features...")
    ...
    print("Plotting validation curve for min_samples_leaf...")
    ...
    print('VALIDATION PROCESS FOR n_estimators BEGAN')
    ...
    print('Plotting validation curve for n_estimators...')
    plot_validation_curve(
        n_estimators_name,
        n_estimators_range,
        clf,
    ...
    print("Validation curve complete for n_estimators.")
    ...
    print("Precision recall plot not conducted.")

    #Previous precision recall code
    ...
    print("Roc plot not conducted.")

    #Previous roc plot code
    """print("Roc plot\n")
    ...
    param_data=[('max_depth', 18),('max_features', 4),('min_samples_split', 5),('n_estimators',16)]
    ...
    try:
        for key in sorted(feature_importances, key=feature_importances.get, reverse=True):
            if feature_importances[key] > 0.01:
                done.write("\t{0}: {1}\n".format(key, feature_importances[key]))
    except:
        done.write('Either the feature importances couldn\'t be compiled, or they were not found.')
