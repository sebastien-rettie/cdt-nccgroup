...
space4knn = {"n_neighbors": hp.choice("n_neighbors", np.arange(2,11,dtype='int'))}
#The above is changed from hp.quniform('n_neighbors',2,10,1)
#hp.quniform throws errors by chosing partitions that are not integers
...
trials = Trials()
best = fmin(fn=f, space=space4knn, algo=tpe.suggest, max_evals=10, trials=trials)
print("best:")
print(best)
