...
datasets = []
for name in names:
    datasets.append((name, np.loadtxt('model_results/single/{0}_singleyear_results.csv'.format(name),unpack=True,delimiter=",")))
...
plt.legend(loc="best")
plt.savefig('graphs/year_accuracy_chifit.png')
